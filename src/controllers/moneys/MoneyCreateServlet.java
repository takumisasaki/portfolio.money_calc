...
/**
 * Servlet implementation class MoneyCreateServlet
 */
@WebServlet("/moneys/create")
public class MoneyCreateServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public MoneyCreateServlet() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(_token != null && _token.equals(request.getSession().getId())) {
            ...
            m.setPerson((Person)request.getSession().getAttribute("login_person"));
            ...
            if(june == null || june.equals("")) {
             ...
             if(errors.size() > 0) {
                 ...
                 RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/moneys/new.jsp");
                 ...
                 em.close();
                 request.getSession().setAttribute("flush", m.getYear() + "年度に" + m.getCompany_name() + "を登録しました。");
